<div id="header" class="group">
    <div class="group inner">
        ...
        <div id="logo" class="group">
            <a href="index.html" title="Pink Rio"><img src="front/images/neetjoker.png" title="Pink Rio"
                                                       alt="Pink Rio"/></a>
        </div>
        <!-- END LOGO -->
        ...
        <div class="menu classic">
            <ul id="nav" class="menu">
                ...
                <li>
                    <a href="news">News</a>
                    <ul class="sub-menu">
                        <li><a href="slider-thumbnails.html">Tin tức đó đây</a></li>
                        <li><a href="slider-layerslider.html">Khoa học thường thức</a></li>
                        <li><a href="slider-flexslider.html">Cuộc sống số</a></li>
                        <li><a href="slider-elastic-slider.html">Xa luận</a></li>
                        <li><a href="slider-cycle.html">Bạn nên biết</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">Game Zone</a>
