...
<head>
    ...
    <script src="public/Picture-cut/src/jquery.picture.cut.js"></script>

    <link rel="stylesheet" href="public/Picture-cut/src/windows/JanelaBootstrap/jquery-ui-1.10.0.custom.css" type="text/css">
...
<script type="text/javascript" language="javascript" src="public/admin/ckeditor/ckeditor.js"></script>
@yield('script')
